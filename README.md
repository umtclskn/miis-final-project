...
```
cd existing_repo
git remote add origin https://gitlab.com/mtclskn/upf_master_thesis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/mtclskn/upf_master_thesis/-/settings/integrations)
